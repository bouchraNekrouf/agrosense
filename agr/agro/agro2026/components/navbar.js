...
(function () {
    ...
    function injectDependencies() {
        ...
        if (!document.querySelector('style[data-navbar="styles"]')) {
            ...
            style.textContent = [
                ...
                '.nav-links  { display: flex; align-items: center; gap: clamp(2px, 0.5vw, 4px); }',
                ...
                '  .agro-lang-trigger { padding: 3px 7px; font-size: 0.62rem; }',
                '}',
                ...
                /* Smooth transition on all elements for theme switch */
                'body * {',
                '  transition: background-color 0.3s ease, color 0.3s ease, border-color 0.3s ease;',
                '}',

                /* ===== Page-wide Dark / Light Mode ===== */
                '[data-theme="dark"] body { background:#06130b !important; color:#ffffff !important; }',
                '[data-theme="light"] body { background:#f0fff4 !important; color:#1a2e1a !important; }',
                '[data-theme="dark"] .neural-background { background: radial-gradient(circle at 50% -20%, rgba(255, 255, 255, 0.12) 0%, transparent 50%), radial-gradient(circle at 15% 85%, rgba(129, 243, 186, 0.08) 0%, transparent 50%), radial-gradient(circle at 85% 15%, rgba(130, 233, 164, 0.15) 0%, transparent 50%), linear-gradient(to bottom, #06130b 0%, #020604 100%) !important; }',
                '[data-theme="light"] .neural-background { background:linear-gradient(135deg,#e8f5e9 0%,#f0fff4 100%) !important; }',
                '[data-theme="light"] .glass,[data-theme="light"] .glass-strong { background:rgba(240,255,244,0.92) !important; color:#1a2e1a !important; border-color:rgba(44,90,54,0.18) !important; }',
                '[data-theme="dark"] .glass,[data-theme="dark"] .glass-strong { background:rgba(10,31,14,0.7) !important; color:#e2fff0 !important; }',

                /* ===== Light Mode: Navbar overrides ===== */
                '[data-theme="light"] .top-bar {',
                '  background: rgba(240,250,244,0.95) !important;',
                '  border-bottom: 1px solid rgba(44,90,54,0.18) !important;',
                '}',
                '[data-theme="light"] .brand-name {',
                '  background: linear-gradient(135deg, #0a3d1f, #2c7a4b) !important;',
                '  -webkit-background-clip: text !important;',
                '  background-clip: text !important;',
                '  -webkit-text-fill-color: transparent !important;',
                '}',
                '[data-theme="light"] .nav-link { color: rgba(10,40,20,0.85) !important; }',
                '[data-theme="light"] .nav-link:hover { color: #0a3d1f !important; background: rgba(44,90,54,0.1) !important; }',
                '[data-theme="light"] .nav-link.active { color: #2c7a4b !important; background: rgba(44,90,54,0.12) !important; border-color: rgba(44,90,54,0.3) !important; }',
                '[data-theme="light"] .user-pill { background: rgba(44,90,54,0.08) !important; border-color: rgba(44,90,54,0.2) !important; }',
                '[data-theme="light"] .user-pill .uname { color: rgba(10,40,20,0.9) !important; }',
                '[data-theme="light"] .menu-toggle { background: rgba(44,90,54,0.08) !important; border-color: rgba(44,90,54,0.2) !important; }',
                '[data-theme="light"] .menu-line { background: #2c7a4b !important; }',
                '[data-theme="light"] .dropdown-menu { background: rgba(245,255,250,0.98) !important; border-color: rgba(44,90,54,0.2) !important; box-shadow: 0 20px 60px rgba(0,0,0,0.15) !important; }',
                '[data-theme="light"] .dropdown-header { border-bottom-color: rgba(44,90,54,0.12) !important; }',
                '[data-theme="light"] .user-info-name { color: #0a1f0e !important; }',
                '[data-theme="light"] .user-info-type { color: rgba(10,31,14,0.55) !important; }',
                '[data-theme="light"] .menu-item { color: rgba(10,31,14,0.85) !important; }',
                '[data-theme="light"] .menu-item:hover { background: rgba(44,90,54,0.08) !important; color: #0a1f0e !important; }',
                '[data-theme="light"] .menu-item .item-icon { background: rgba(44,90,54,0.08) !important; }',
                '[data-theme="light"] .menu-divider { background: rgba(44,90,54,0.1) !important; }',
                '[data-theme="light"] .dash-icon-btn { background: rgba(44,90,54,0.08) !important; border-color: rgba(44,90,54,0.2) !important; color: rgba(10,40,20,0.8) !important; }',

                /* ===== Language Switcher Dropdown ===== */
                '.navbar-controls { display: flex; align-items: center; gap: 6px; }',
                '.agro-lang-wrapper { position: relative; }',
                '.agro-lang-trigger {',
                ...
                '  font-size: clamp(0.65rem, 0.9vw, 0.8rem); font-weight: 500;',
                '  cursor: pointer; font-family: inherit; white-space: nowrap;',
                '  transition: all 0.2s ease;',
                '}',
                '.agro-lang-trigger:hover { background: rgba(130,233,164,0.15); border-color: rgba(130,233,164,0.4); color: #fff; }',
                '[data-theme="light"] .agro-lang-trigger { background: rgba(44,90,54,0.08) !important; border-color: rgba(44,90,54,0.2) !important; color: rgba(10,40,20,0.8) !important; }',
                '.agro-lang-dropdown {',
                '  position: absolute; top: calc(100% + 6px); right: 0;',
                '  background: rgba(10,31,14,0.97); backdrop-filter: blur(20px);',
                '  border: 1px solid rgba(130,233,164,0.2); border-radius: 12px;',
                '  padding: 6px; display: none; flex-direction: column; gap: 2px;',
                '  z-index: 1002; min-width: 110px;',
                '  box-shadow: 0 8px 30px rgba(0,0,0,0.5);',
                '}',
                '.agro-lang-dropdown.open { display: flex; animation: langDropIn 0.15s ease; }',
                '@keyframes langDropIn { from { opacity:0; transform:translateY(-6px); } to { opacity:1; transform:translateY(0); } }',
                '.agro-lang-item {',
                '  display: flex; align-items: center; gap: 8px;',
                '  background: transparent; border: none; border-radius: 8px;',
                '  padding: 7px 12px; color: rgba(255,255,255,0.7);',
                '  font-size: 0.85rem; font-weight: 500; cursor: pointer;',
                '  font-family: inherit; text-align: left; transition: all 0.2s ease;',
                '  white-space: nowrap;',
                '}',
                '.agro-lang-item:hover { background: rgba(130,233,164,0.12); color: #fff; }',
                '.agro-lang-item.active { color: #81f3ba !important; font-weight: 700; background: rgba(130,233,164,0.1); }',
                '[data-theme="light"] .agro-lang-dropdown { background: rgba(245,255,250,0.98) !important; border-color: rgba(44,90,54,0.2) !important; box-shadow: 0 8px 30px rgba(0,0,0,0.12) !important; }',
                '[data-theme="light"] .agro-lang-item { color: rgba(10,40,20,0.7) !important; }',
                '[data-theme="light"] .agro-lang-item:hover { background: rgba(44,90,54,0.08) !important; color: #0a1f0e !important; }',
                '[dir="rtl"] .agro-lang-dropdown { right: auto; left: 0; }',

                /* ===== Dark Mode Toggle Button ===== */
                '.dark-mode-toggle {',
                '  background: rgba(130,233,164,0.08);',
                '  border: 1px solid rgba(130,233,164,0.2);',
                '  border-radius: 50%; width: clamp(28px,2.5vw,36px); height: clamp(28px,2.5vw,36px);',
                '  display: flex; align-items: center; justify-content: center;',
                '  cursor: pointer; font-size: clamp(0.75rem,1vw,1rem);',
                '  transition: background 0.3s ease, border-color 0.3s ease, transform 0.2s ease;',
                '  flex-shrink: 0;',
                '}',
                '.dark-mode-toggle:hover {',
                '  background: rgba(130,233,164,0.15); border-color: rgba(130,233,164,0.4);',
                '  transform: scale(1.1);',
                '}',
                '[data-theme="light"] .dark-mode-toggle {',
                '  background: rgba(44,90,54,0.08) !important;',
                '  border-color: rgba(44,90,54,0.2) !important;',
                '}',

                /* ===== RTL Support ===== */
                '[dir="rtl"] .top-bar { flex-direction: row; }',
                '[dir="rtl"] .brand { flex-direction: row-reverse; }',
                '[dir="rtl"] .nav-right { flex-direction: row-reverse; }',
                '[dir="rtl"] .menu-item:hover { transform: translateX(-4px); }',
                '[dir="rtl"] .dropdown-menu { right: auto !important; left: 50px; }',
                '[dir="rtl"] .item-text { text-align: right; }',
                '[dir="rtl"] #sidePanelConfig { right: auto !important; left: -420px !important; border-left: none !important; border-right: 1px solid rgba(0,220,130,0.3) !important; }',
                '@media (max-width: 768px) {',
                '  [dir="rtl"] .dropdown-menu { right: auto !important; left: 20px; }',
        ...
        // ── i18n: load translations.js → then i18n.js (in order) ─────
        if (!document.querySelector('script[data-navbar="translations"]')) {
            var translScript = document.createElement('script');
            translScript.src = '/components/translations.js';
            translScript.setAttribute('data-navbar', 'translations');
            translScript.onload = function () {
                if (!document.querySelector('script[data-navbar="i18n"]')) {
                    var i18nScript = document.createElement('script');
                    i18nScript.src = '/components/i18n.js';
                    i18nScript.setAttribute('data-navbar', 'i18n');
                    i18nScript.onload = function () {
                        // Apply translations to any data-i18n elements already in DOM
                        if (window.AgroI18n) {
                            window.AgroI18n.apply(window.AgroI18n.getCurrent());
                        }
                    };
                    document.head.appendChild(i18nScript);
                }
            };
            document.head.appendChild(translScript);
        }
    }
    ...
    /**
     * Reads saved theme or falls back to prefers-color-scheme.
     * Sets data-theme on <html> and updates the toggle button icon.
     */
    function initDarkMode() {
        var saved = localStorage.getItem('agro_theme');
        var theme;
        if (saved) {
            theme = saved;
        } else {
    ...
    // Apply dark mode ASAP (before navbar.html loads) to avoid flash
    (function () {
        var saved = localStorage.getItem('agro_theme');
        if (saved) {
    ...
    /**
     * Injects the language switcher (AR | EN | FR) and dark/light toggle
     * into the navbar's .nav-right, before the user pill.
     * Idempotent — safe to call multiple times.
     */
    function injectGlobalControls() {
        if (document.getElementById('navbar-controls')) return;
        ...
        var currentInfo = langs.filter(function (l) { return l.code === currentLang; })[0] || langs[1];

        var langWrapper = document.createElement('div');
        langWrapper.className = 'agro-lang-wrapper';

        var langTrigger = document.createElement('button');
        langTrigger.id = 'agro-lang-trigger';
        langTrigger.className = 'agro-lang-trigger';
        langTrigger.setAttribute('aria-label', 'Language / اللغة / Langue');
        langTrigger.textContent = currentInfo.flag + ' ' + currentInfo.label + ' ▾';

        var langDropdown = document.createElement('div');
        langDropdown.id = 'agro-lang-dropdown';
        langDropdown.className = 'agro-lang-dropdown';

        langs.forEach(function (lang) {
            var item = document.createElement('button');
            item.className = 'agro-lang-item' + (lang.code === currentLang ? ' active' : '');
            item.setAttribute('data-lang', lang.code);
            item.textContent = lang.flag + ' ' + lang.label;
            item.onclick = function (e) {
                e.stopPropagation();
                if (window.AgroI18n) {
                    window.AgroI18n.setLanguage(lang.code);
                } else {
        ...
        var savedTheme = localStorage.getItem('agro_theme') || 'dark';
        darkBtn.textContent = savedTheme === 'dark' ? '🌙' : '☀️';
        darkBtn.setAttribute('aria-label', 'Toggle dark/light mode');
        darkBtn.onclick = function () { window.toggleDarkMode(); };

        controls.appendChild(langWrapper);
        controls.appendChild(darkBtn);

        // Insert before user pill (or append if pill absent)
        navRight.insertBefore(controls, userPill || null);
    }
...
desc: 'Prévision de récolte, engrais et rendement',            },
    ...
    function initNavbar() {
        ...
        // Inject language switcher + dark mode toggle
        injectGlobalControls();

        // Sync dark mode button icon after controls are injected
        initDarkMode();

        // Apply i18n to navbar elements — retry until translations.js is loaded
        var i18nRetries = 0;
        function applyNavI18n() {
            if (window.AgroI18n) {
                window.AgroI18n.apply(window.AgroI18n.getCurrent());
            } else if (i18nRetries++ < 30) {
                setTimeout(applyNavI18n, 80);
            }
        }
        applyNavI18n();
    }
...
if (navRight && userPill && !document.getElementById('dash-app-icons') && ROLE !== 'admin') {
    ...
    function injectDropdownItems() {
        ...
        if (roleEl) {
            if (ROLE === 'admin') {
                ...
                roleEl.textContent = 'Agriculteur 🚜';
            }
        }
    ...
    function setUserInfo() {
        ...
        if (isLoggedIn) {
            ...
            if (!document.getElementById('navbar-guest-actions') && navRight) {
                ...
                btnLogin.setAttribute('data-i18n', 'Connexion');
                ...
                btnReg.setAttribute('data-i18n', 'Inscription');
                ...
                // Apply current language to newly injected buttons
                if (window.AgroI18n) window.AgroI18n.apply(window.AgroI18n.getCurrent());
            }
        }
    }
    ...
    // ── 8. BOOT ───────────────────────────────────────────────────────
    // Step 0 (already done above): Apply dark-mode theme immediately to prevent flash.
    // Step 1: Inject CSS + fonts + socket.io + translations.js + i18n.js
    injectDependencies();
    ...
    // (initNavbar will call injectGlobalControls + initDarkMode + i18n re-apply)
    if (document.readyState === 'loading') {
